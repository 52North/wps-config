    ...
    public static class GeneratorImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.n52.wps.GeneratorDocument.Generator
    {
        ...
        public org.n52.wps.GeneratorDocument.Generator.Name xgetName()
        {
            synchronized (monitor())
            {
                ...
                target = (org.n52.wps.GeneratorDocument.Generator.Name)get_store().find_attribute_user(NAME$2);
                return target;
            }
        }
        ...
        public void xsetName(org.n52.wps.GeneratorDocument.Generator.Name name)
        {
            synchronized (monitor())
            {
                ...
                if (target == null)
                {
                    target = (org.n52.wps.GeneratorDocument.Generator.Name)get_store().add_attribute_user(NAME$2);
                }
                target.set(name);
            }
        }
        ...
        public org.n52.wps.GeneratorDocument.Generator.ClassName xgetClassName()
        {
            synchronized (monitor())
            {
                ...
                target = (org.n52.wps.GeneratorDocument.Generator.ClassName)get_store().find_attribute_user(CLASSNAME$4);
                return target;
            }
        }
        ...
        public void xsetClassName(org.n52.wps.GeneratorDocument.Generator.ClassName className)
        {
            synchronized (monitor())
            {
                ...
                if (target == null)
                {
                    target = (org.n52.wps.GeneratorDocument.Generator.ClassName)get_store().add_attribute_user(CLASSNAME$4);
                }
